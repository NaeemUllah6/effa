      ...
      <div className='my-6 md:my-12'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 mt-6 md:mt-12 items-center justify-between gap-5 max-w-[1104px] mx-auto'>
          ...
          <div className='max-w-[377px]'>
            <h3 className='text-[#4C525B] text-3xl md:text-[32px] font-light fontArchivo'>Watch the Roundtable</h3>
            ...
            <Button className='bg-[#052043] hover:bg-[#052043] text-white border-none h-[54px] md:h-[58px] mt-4 md:mt-8 w-full md:w-fit'>
              Register Here
            </Button>
          </div>
        </div>
